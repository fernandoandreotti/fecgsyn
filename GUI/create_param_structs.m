function [ param_struct ] = create_param_structs( varargin )
...
%% DS 3 - Noise + Respiration

param = param_struct{3};

    param.title = 'Noise and Respiration';
...
%% Add missing values
for i = 1:length(param_struct)
    param_struct{i} = add_default_params(param_struct{i}, varargin);
end
