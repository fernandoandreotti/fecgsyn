...
for k = 1 : Samples
    ...
    for jj = 1:size(Z,1);
        ...
        YY = Yminus(jj);
        [HH,VV] = FECGx_kf_Linearization(XX,Wmean,alphai,bi,tetai,w,fs,1);  % Linearized observation eq.
    ...
    [A,F] = FECGx_kf_Linearization(XX,Wmean,alphai,bi,tetai,w,fs,0);   % Linearized equations
