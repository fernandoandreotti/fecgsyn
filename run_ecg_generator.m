...
if nargin > 1
    ...
    [mixture,mecg,fecg,noise] = generate_ecg_mixture(debug,param.SNRfm,param.SNRmn,m_model,f_model{:},n_model{:});
    mixture = mixture-repmat(mean(mixture),NB_ELEC,1);
