function sqi = bassqi(signal,fs)
%pSQI Power of Baseline SQI
% 
% Returns the relative power on band P(0-3Hz)/P(0-100Hz)
% 
% 
% Input:
...
pband = bandpower(signal,fs,[0 3]);
ptot = bandpower(signal,fs,[0 100]);
sqi = (pband/ptot);
